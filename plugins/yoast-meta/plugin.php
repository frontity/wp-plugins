...
if ( ! class_exists( 'Frontity_Yoast_Meta' ) ) {
	require_once FRONTITY_YOAST_META_PATH . 'class-frontity-plugin.php';
...
register_activation_hook( __FILE__, array( $frontity_yoast_meta, 'activate' ) );
register_deactivation_hook( __FILE__, array( $frontity_yoast_meta, 'deactivate' ) );
